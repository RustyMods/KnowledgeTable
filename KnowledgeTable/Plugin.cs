...
using KnowledgeTable.KnowledgeTable;
...
namespace KnowledgeTable
{
    ...
    public class KnowledgeTablePlugin : BaseUnityPlugin
    {
        ...
        public static readonly ManualLogSource KnowledgeTableLogger = BepInEx.Logging.Logger.CreateLogSource(ModName);
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                KnowledgeTableLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                KnowledgeTableLogger.LogError($"There was an issue loading your {ConfigFileName}");
                KnowledgeTableLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
        #endregion
